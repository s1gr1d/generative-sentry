  ...
  return (
    <ErrorBoundary>
      <div style={{ height, width: '100%', position: 'relative' }}>
        ...
        >
          <div style={{ marginBottom: '4px' }}>🖱️ <strong>Hover over letters</strong> to apply forces</div>
          <div style={{ marginBottom: '4px' }}>🎯 <strong>Drag to orbit</strong> • <strong>Scroll to zoom</strong></div>
