...
export const alphabetSoupSection: SectionDefinition = {
  ...
  bodyText: 'Interactive 3D visualization where error data transforms into floating letters. Each character represents fragments from Sentry error messages, function names, and exception types. Hover over letters to apply directional forces and watch them dance through the digital soup!',
  order: 8, // After artistic cubes
  component: () =>         <AlphabetSoupCanvas
