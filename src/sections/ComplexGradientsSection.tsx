...
export const complexGradientsSection: SectionDefinition = {
	...
	bodyText:
		"Multi-layered color effects with advanced shader techniques. This piece combines multiple gradient algorithms to create complex, sophisticated visual patterns that demonstrate the power of modern GPU computing.",
	order: 3,
	component: () => (
