...
export const gradientWavesSection: SectionDefinition = {
	...
	bodyText:
		"Flowing animated gradients that ripple across the canvas like gentle waves. This foundational piece explores the basic principles of computational color theory and smooth motion.",
	order: 1,
	component: () => (
