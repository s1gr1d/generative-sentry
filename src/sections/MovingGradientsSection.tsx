...
export const movingGradientsSection: SectionDefinition = {
	...
	bodyText:
		"Dynamic color transitions powered by shader programming. Watch as colors blend and flow in smooth, hypnotic motions that showcase the beauty of computational art and real-time graphics rendering.",
	order: 2,
	component: () => (
