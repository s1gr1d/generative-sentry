...
export const NORMALIZED_RGB = Object.fromEntries(
  Object.entries(RGB_VALUES).map(([key, [r, g, b]]) => [
    key,
    [r / 255, g / 255, b / 255] as const
  ])
...
export const COLOR_CATEGORIES = {
  ...
  PURPLES: [PRIMARY_COLORS.DK_VIOLET, PRIMARY_COLORS.LT_VIOLET, PRIMARY_COLORS.DK_PURPLE, PRIMARY_COLORS.LT_PURPLE],
  BLURPLES: [PRIMARY_COLORS.DK_BLURPLE, PRIMARY_COLORS.BLURPLE, PRIMARY_COLORS.LT_BLURPLE],
  WARM: [SECONDARY_COLORS.DK_PINK, SECONDARY_COLORS.LT_PINK, SECONDARY_COLORS.DK_ORANGE, SECONDARY_COLORS.LT_ORANGE, SECONDARY_COLORS.DK_YELLOW, SECONDARY_COLORS.LT_YELLOW],
  COOL: [TERTIARY_COLORS.DK_GREEN, TERTIARY_COLORS.LT_GREEN, TERTIARY_COLORS.DK_BLUE, TERTIARY_COLORS.LT_BLUE],
...
export const getRandomColors = (count: number, category: keyof typeof COLOR_CATEGORIES = 'ALL'): string[] => {
  const colors = [...COLOR_CATEGORIES[category]]
  const result: string[] = []
